        ...
        <ColumnWrap>
          ...
          <Place time="Jul 2022 - Apr 2023" place="EDD London">
            ...
            <Para>
              ...
              UI with custom components to take advantage of their theming
              system and laying the groundwork for a white label offering.
            </Para>
            <Para>
              Fun new things included React Hook Forms, mocking with Faker &amp;
              MSW, state and data fetching with React Query, animation with
              framer motion, and for the CMS content I consumed a custom
              Headless CMS.
            </Para>
          </Place>
          ...
          <Place time="Apr 2021 - Jul 2022" place="Festicket">
            <Para>
              ...
              on fees and sales performance. Working in small teams we built out
              a succession of portals and other components in a large mostly
          ...
          <Place time="Sept 2020 - Mar 2021" place="Jollywise">
            <Para>
              ...
              Christmas quiz SPA, and built a set of React / JS dragon-themed
              mini games.
            </Para>
          </Place>
          ...
          <Place time="Oct 2019 - Feb 2020  / Jun 2020" place="Rehab Agency">
            <Para>
              ...
              JSON form. Ended up leading the field and advising parallel
          ...
          <Place time="May - Sept 2018" place="KoffeeCup">
            <Para>
              ...
              needed urgent updating for a client company conference. Updated it
              with a new year of content, assets & structure for an on-site
          ...
          <Place time="Jul 2015 - Dec 2017" place="YunoJuno">
            <Para>
              ...
              system using practical BEM, Stylus/SASS and Django templating,
              later moving to React.
            </Para>
            <Para>
              A highlight was carrying out a platform-wide redesign with a
              single CSS retheme for a seamless and non-destructive transition.
            </Para>
          </Place>
          ...
          <NoColWrap>
            ...
            <Place time="2012 - 2014: " place="VML London">
              ...
              <Para>
                ...
                that receives 500k uniques a day and 3mil in revenue a week. As
                the team increased from 6 devs to 20 I started out as Front-end
                lead then specialised to CSS and UX Lead.
              </Para>
              <Para>
                I also organised knowledge-sharing workshops, was on the social
                media committee as tech voice, &amp; was in-house photographer
