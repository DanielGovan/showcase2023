  ...
  return (
    <div className="flex-3/4 print:flex-3/5">
      ...
      <Para>
        ...
        development has given me a collaborative focus and a great eye for UX,
        while 10 years in contract roles means I&rsquo;m well-versed in adapting
        to new teams, patterns and codebases; vital qualities in the ever
        changing front end stack.
      </Para>
      <Para>
        ...
        pragmatic, user-first approach to every project.
      </Para>
    </div>
  );
};
